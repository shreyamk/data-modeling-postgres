...
def process_song_file(cur, filepath):
    """Function to process song files and insert values into song and artist tables"""
    # open song file
...
def process_log_file(cur, filepath):
    """Function to process log files and insert values into user and song play tables"""
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def main():
    """Main function that includes function calls to the above defined functions"""
